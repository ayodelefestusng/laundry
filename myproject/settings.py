...
EMAIL_PORT = 465
EMAIL_USE_SSL = True   # because port 465 is SSL
EMAIL_HOST_USER = "laundry@dignityconcept.tech"
EMAIL_HOST_PASSWORD = "BUeu^vKv8@dH{&1U"   # your mailbox password
DEFAULT_FROM_EMAIL = "Dignity Concept <laundry@dignityconcept.tech>"
