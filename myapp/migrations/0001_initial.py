...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('pending_invoice', 'Pending Invoice'), ('invoice_sent', 'Invoice Sent'), ('payment_received', 'Payment Received'), ('in_progress', 'In Progress'), ('ready_for_pickup', 'Ready for Pickup'), ('delivered', 'Delivered'), ('canceled', 'Canceled')], default='pending_invoice', max_length=20)),
        ...
        migrations.AddField(
            model_name='service',
            name='category',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='myapp.servicecategory'),
        ),
        migrations.AddField(
            model_name='service',
            name='service_type',
