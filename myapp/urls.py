...
urlpatterns = [
    ...
    path('htmx/order-summary/<int:order_id>/', views.htmx_get_order_summary, name='htmx_get_order_summary'),
    ...
    path('admins/approve-comment/<int:order_id>/', views.admin_approve_comment, name='admin_approve_comment'),
]
